...
def DESCENT_DIR(A,b,c,d,x_hat, p_array_2d_dict, camera_dict, linear_estimates):
...
def visualize_3D(point_cloud_array_3D):
    '''
    ...
    ax_3d.scatter(point_cloud_array_3D[:, 0], point_cloud_array_3D[:, 1], point_cloud_array_3D[:, 2], ".")
